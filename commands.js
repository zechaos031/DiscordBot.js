            ...
            if (msg.channel.permissionsFor(msg.guild.me)
              .has('EMBED_LINKS')) {
                ...
                .setTitle(`Aide Commande n°1`)
                  .addField(`${discordbotjs.botPrefix}server-info`, `Affiche les informations du serveur`)
                  .addField(`${discordbotjs.botPrefix}user-info`, `Afiiche vos informations non personnel`)
                  .addField(`${discordbotjs.botPrefix}bot-info`, `Affiche les informations du bot`)
                  .addField(`${discordbotjs.botPrefix}channel-info`, `Affiche les informations d'un salon`)
                  .addField(`${discordbotjs.botPrefix}role-info`, `Affiche les informations d'un rôle`)
            .addField(`${discordbotjs.botPrefix}server-list`, `Affiche les serveurs où le bot est connecté`)
            .addField(`${discordbotjs.botPrefix}server-invite`, `Commande permettant de générer un lien d'invitation du serveur`)
                  .addField(`${discordbotjs.botPrefix}kick`, `Commande permettant de kicker un membre`)
                  .addField(`${discordbotjs.botPrefix}ban`, `Commande permettant de bannir un membre`)
                  .addField(`${discordbotjs.botPrefix}report`, `Commande permettant de reporter un membre`)
                  .addField(`${discordbotjs.botPrefix}mute`, `Commande permettant de mettre en soudrine un membre`)
                  .addField(`${discordbotjs.botPrefix}unmute`, `Commande permettant d'enlever sourdine d'un membre`)
            .addField(`${discordbotjs.botPrefix}bot-vote`, `Commande permettant de voter pour DiscordBot.Js`)
              .addField(`${discordbotjs.botPrefix}chifoumi`, `Commande permettant de jouer aux chifoumi`)
                  .addField(`${discordbotjs.botPrefix}clear`, `Commande permettant de supprimer des messsages`)
                  .addField(`${discordbotjs.botPrefix}ping`, `Commande permettant d'afficher le ping`)
                  .addField(`${discordbotjs.botPrefix}say`, `Commande permettant de faire parler le bot`)
                  .addField(`${discordbotjs.botPrefix}say-markdown`, `Commande permettant de faire parler le bot avec les markdown de discord`)
            .addField(`${discordbotjs.botPrefix}logs-channel`, `Commande permettant de configurer le salon Logs\n(Veuillez renseignez l'ID du channel !)`)
            .addField(`${discordbotjs.botPrefix}setup-server`, `Commande permettant de configurer un serveur`)
            .addField(`${discordbotjs.botPrefix}embed-help`, `Aide pour crée un embed`)
                  .addField(`${discordbotjs.botPrefix}poll-help`, `Aide pour crée un sondage`)
            .addField(`${discordbotjs.botPrefix}xp-help`, `Aide pour le système d'xp`)
                  .addField(`${discordbotjs.botPrefix + config.prefixMusic}help`, `Affiche les commandes de musique`)
            msg.channel.send(embed1);
            const embed2 = new Discord.RichEmbed()
                .setColor(`${config.colorembed}`)
                .setTitle(`Aide Commande n°2`)
                  .addField(`${discordbotjs.botPrefix}new-prefix`, `Commande permettant de changer le prefix du bot`)
                  .addField(`${discordbotjs.botPrefix}money-help`, `Aide pour le système d'argent`)
                  .addField(`${discordbotjs.botPrefix}webhook-help`, `Aide pour configurer un webhook`)
                  .addField(`${discordbotjs.botPrefix}invite-list`, `Cette commande a été remplacé par ${discordbotjs.botPrefix}server-invite`)
                  .addField(`${discordbotjs.botPrefix}add-role`, `Commande permettant d'ajouter un rôle à un membre`)
                  .addField(`${discordbotjs.botPrefix}remove-role`, `Commande permettant d'enlever un rôle à un membre`)
                  .addField(`${discordbotjs.botPrefix}unban`, `Commande permettant de débannir un membre`)
                  .addField(`${discordbotjs.botPrefix}news`, `Commande permettant de recevoir des actualités de DiscordBot.Js`)
